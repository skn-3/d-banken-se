      ...
      <main className="relative z-10 mx-auto w-full max-w-6xl px-6 pb-24 pt-4">
        {ctx?.isPreview && (
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-2xl border-2 px-4 py-3 shadow-sm"
            ...
            <button className="btn-secondary !px-3 !py-1 text-xs" onClick={() => navigate({ to: "/admin", search: { tab: undefined, sub: undefined, q: undefined, from: undefined, to: undefined, tema: undefined, status: undefined, team: undefined, proj: undefined, highlight: undefined } })}>← Tillbaka till admin</button>
          </div>
        )}
