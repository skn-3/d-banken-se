// Shared branded newsletter renderer — matches the thanks-email skeleton.
...
export function renderNewsletterEmail(a: NewsletterArgs): string {
  ...
  const preheader = a.preheader || a.headline;
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#F4FAF5;padding:24px 12px;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
      ...
      <tr><td style="padding:0 0 18px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0B3D2E;border-radius:20px;">
          <tr><td align="center" style="padding:34px 28px 30px;">
            ...
            <div style="font-family:${mono};font-size:11px;letter-spacing:0.32em;color:#9FD9B6;text-transform:uppercase;">SMARTKLIMAT</div>
          </td></tr>
        </table>
      </td></tr>
      ...
      <tr><td align="center" style="padding:12px 0 24px;font-family:${body};font-size:11px;color:#8AA69B;">
        Du får detta mail som köpare hos SmartKlimat.
